      ...
      <div class="container">
         <div class="row pt-5 text-center">
            ...
            <p class="pt-2" style="line-height:2.2">We are the unmatched pioneers in providing the most affordable Aerial stock video content to creators all over the world without
               ...
               and efficient manner. Our stock footage can be used in a variety of manners. The project can be a personal endeavour or a professional commitment,
               you can be assured that Our Drone footages is of unrivalled quality, which will enhance and elevate your content to the next level in the most definite manner.
            </p>
         </div>
         <div class="row pt-2 text-center">
            ...
            <p class="pt-2" style="line-height:2.2">Stock footage or free royalty free videos available in the market are produced for the international market. It is very disheartening for Creators and advertisers
               ...
               Drone Stock Clips caught on the pain point and curated this platform where no content creator needs to ever struggle again to find Drone stock footage.
            </p>
         </div>
         <div class="row pt-2 text-center">
            <h2 class="font-weight-bold" style="color:#6EC1E4">
            ...
            <p class="pt-2" style="line-height:2.2">Besides the fact that our Drone stock footage is unique, we also provide free royalty free stock footage. Our competitive pricing is at par with the stock footage services offered by us.
               ...
               us is that we are desi at heart. You will know that the aerial stock footage bought from us comes from a team that is producing video content using drones specifically by keeping
               content creators, filmemakers, publishers and advertisers in mind.
            </p>
         </div>
         <div class="row pt-2 text-center">
            <h2 class="font-weight-bold" style="color:#6EC1E4">
            ...
            <p> Valid worldwide with no geographic restrictions</p>
            <p>Cover both personal and commercial projects.</p>
            <p>Don’t have limits on the number of projects, production budget or distribution </p>
            <p>With dronestockclips.com every clip you</p>
         ...
         <div class="row pt-2 text-center">
            ...
            <p class="pt-2" style="line-height:2.2">Our team consists of passionate drone pilots who have a strong background in large-scale content creation and experience in handling multiple production projects simultaneously.
               ...
               We noticed the gap left in the Aerial stock video footage industry that offers neither quality Aerial stock footage nor exclusive royalty free drone footage.
               With our vision, project execution and implementation skills made Dronestockclips.com possible and achieve the success it has.
               We are backed by some big Hollywood names who are not only very excited about this technology, but are great advisers as to what is required in the world of film and TV.
               Being based in Hollywood definitely has it’s advantages!. We only have super high-quality footage. We like amazing!
            </p>
         </div>
         <div class="row pt-2 text-center">
            <h2 class="font-weight-bold" style="color:#6EC1E4">
