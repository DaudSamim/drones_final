...
<style>
  ...
  @include('header_for_single_page')
            ...
            <div class="col-md-12">
               <div class="row justify-content-center mb-4">
                  <div class="col-md-8 text-center  form-search-wrap" style="margin-top: 15%" >
                     <h1 style="color: black; font-weight: 800" class="" data-aos="fade-up">About Us </h1>
                  </div>
               </div>
            </div>
         </div>
   ...
   <p>We are the African drone pilots, a team that aims to bring to you the most beautiful and impressive quality footages from Africa and all over the world. AFRICAN DRONE STOCK is aerial stock footage boutique consisting of the best drone video clips with High-Quality Content From All Over The World. It was set up by African Drone Pilot Operators and aircraft pilots with large library of videos as a solution to provide a portal for aerial videos online with easy access for both contributors and customers.

First and foremost, It was created for the love of filmmaking, but also capturing spontaneous moments in an environment that is raw, genuine, real, that ultimately helps creative professionals tell their story more clearly, with more heart, and more clarity.

We believe that quality video content should be more affordable to masses of media creators. That’s why on average our clips cost a fraction of what single video clip may cost traditionally. We thank you for your support and help in growing African drone stock</p>
   </div>
   </div>
   </div>
