                ...
                <div class="row productflexfix">
                    ...
                    <div class="col-md-8 col-xs-12 single_main_header_products">
                        <div class="single--post--content">
                            <h1 class="single-post-title">Search results</h1>
                        </div>
                    </div>
                            ...
                            <nav id="breadcrumbs" class="">
                                <ol class="breadcrumb" itemscope="itemscope"
                                    ...
                                    <li class="active" itemscope="itemscope" itemtype="https://schema.org/ListItem"
                                        itemprop="itemListElement"><span itemprop="item"></span></li>
                                </ol>
                            </nav>
                        </ul>
                                ...
                                <div class="products_list_index">
                                    <div class="row">
                                        <div class="row main-cat-cntrs ">
                                            <h2 class="bold_header text-center" style="font-weight: 900">Videos for : {{$keyword}}</h2>
