         ...
         <div class="col-md-12">
            <div class="row justify-content-center mb-4">
               <div class="col-md-8 text-center  form-search-wrap" style="margin-top: 15%" >
                  <h1 style="color: white; font-weight: 800" class="" data-aos="fade-up">Blogs</h1>
               </div>
            </div>
         </div>
      </div>
...
<div class="container">
    ...
    <div class="col-lg-5 col 12">
                <h4 class="pb-4">{{$main_blog->title}}</h4>    
                <img style="height:250px" src="images/{{$main_blog->image}}">
            </div>
...
<div class="container">
   <div class="row">
      ...
      <form action="/add_comment" class="p-5 bg-white">
<h6 class="mb-5 text-center">Leave a comment</h6>
<div class="row form-group">
<div class="col-md-12">
<label style="background-color:#F3F3F3" class="text-black row"></label>
@if(auth()->user()->id==null)
<div style="background-color:#F3F3F3" class="row">
<p> <a style="color:blue" href="/">Login</a>  to leave a comment</p>
@else
<div style="background-color:#F3F3F3" class="row">
<textarea name="comment" id=""  rows="2" placeholder="Leave a comment"></textarea>
</div>
<div class="row form-group">
